...
userDetailsModel.hasMany(stmModel,{foreignKey: 'reviewee_id',sourceKey:'user_id'});
userDetailsModel.hasMany(stmModel,{foreignKey: 'reviewer_id',sourceKey:'user_id'});
...
stmModel.belongsTo(userDetailsModel,{foreignKey: 'reviewee_id',as:'reviewer'});
stmModel.belongsTo(userDetailsModel,{foreignKey: 'reviewer_id',as:'reviewee'});
stmModel.belongsTo(templateModel,{foreignKey: 't_id',as:'templates'});
stmModel.belongsTo(sessionModel,{foreignKey: 's_id',as:'sessions'});
